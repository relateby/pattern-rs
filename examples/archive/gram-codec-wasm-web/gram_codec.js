...
export class ParseResult {
     ...
     */
    get identifiers() {
        const ret = wasm.parseresult_identifiers(this.__wbg_ptr);
     ...
     */
    get pattern_count() {
        const ret = wasm.parseresult_pattern_count(this.__wbg_ptr);
        return ret >>> 0;
    }
}
 ...
 * @returns {ParseResult}
 */
export function parse_gram(input) {
    const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.parse_gram(ptr0, len0);
    if (ret[2]) {
 ...
 * @returns {string}
 */
export function round_trip(input) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.round_trip(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {boolean}
 */
export function validate_gram(input) {
    const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.validate_gram(ptr0, len0);
    return ret !== 0;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('gram_codec_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
