...
def example_typed_pattern_subject() -> None:
    """Example with type-annotated Pattern[Subject]."""
    print("=" * 60)
    print("Example 5: Type-Annotated Pattern[Subject]")
    print("=" * 60)
    ...
    # Type checkers know this is Pattern
    pattern: Pattern = Pattern.point(subject)

    # Type checkers know value returns Subject
    value: Subject = pattern.value
