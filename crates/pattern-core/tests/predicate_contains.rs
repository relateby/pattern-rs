...
fn test_contains_direct_element_nested() {
    ...
    let subpattern = Pattern::pattern("branch", vec![
        Pattern::point("leaf"),
    ]);
    assert!(pattern.contains(&subpattern));
}
...
fn test_contains_deeply_nested_descendant() {
    let pattern = Pattern::pattern("root", vec![
        Pattern::pattern("level1", vec![
            Pattern::pattern("level2", vec![
                Pattern::pattern("level3", vec![
                    Pattern::point("deep"),
                ]),
            ]),
        ]),
...
fn test_contains_intermediate_subpattern() {
    ...
    let subpattern = Pattern::pattern("level2", vec![
        Pattern::point("leaf"),
    ]);
    assert!(pattern.contains(&subpattern));
}
...
fn test_contains_not_found_nested() {
    ...
    let subpattern = Pattern::pattern("other", vec![
        Pattern::point("leaf"),
    ]);
    assert!(!pattern.contains(&subpattern));
}
...
fn test_contains_transitivity_complex() {
    let level1 = Pattern::pattern("1", vec![
    ...
    let level2 = Pattern::pattern("2", vec![
        Pattern::pattern("3", vec![
            Pattern::point("4"),
        ]),
    ]);
    let level3 = Pattern::pattern("3", vec![
        Pattern::point("4"),
    ]);
...
fn test_contains_nested_at_various_depths() {
    let pattern = Pattern::pattern("root", vec![
        Pattern::pattern("level1a", vec![
            Pattern::point("deep1"),
        ]),
        Pattern::pattern("level1b", vec![
            Pattern::pattern("level2", vec![
                Pattern::point("deep2"),
            ]),
        ]),
    ...
    assert!(pattern.contains(&Pattern::pattern("level2", vec![
        Pattern::point("deep2"),
    ])));
}
