...
fn test_combine_patterns_multiple_elements() {
    let p1 = Pattern::pattern("x".to_string(), vec![
        Pattern::point("1".to_string()),
        Pattern::point("2".to_string()),
        Pattern::point("3".to_string()),
    ]);
    
    let p2 = Pattern::pattern("y".to_string(), vec![
...
fn test_combine_atomic_with_pattern() {
    ...
    let p2 = Pattern::pattern("parent".to_string(), vec![
...
fn test_combine_pattern_with_atomic() {
    let p1 = Pattern::pattern("parent".to_string(), vec![
        Pattern::point("child".to_string()),
    ]);
...
fn test_combine_pattern_with_itself() {
    let p = Pattern::pattern("self".to_string(), vec![
...
fn test_combine_nested_structures() {
    let p1 = Pattern::pattern("root1".to_string(), vec![
        Pattern::pattern("child1".to_string(), vec![
            Pattern::point("leaf1".to_string()),
        ]),
    ]);
    
    let p2 = Pattern::pattern("root2".to_string(), vec![
